            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.profile') }}" class="btn btn-gradient-primary btn-sm">View Profile</a>
                    </li>
                </ul>
            </nav>
        </div>
            ...
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                    <div class="card-body">
                        ...
                        <h4 class="font-weight-normal mb-3">Total Admins <i class="mdi mdi-account-star mdi-24px float-end"></i></h4>
                        <h2 class="mb-5">{{ $adminCount }}</h2>
                        <h6 class="card-text">Total Admins Registered</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                    <div class="card-body">
                        ...
                        <h6 class="card-text">Total Users Registered</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
